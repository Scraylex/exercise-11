...
public class Lab extends LearningEnvironment {
    ...
    /**
     * {@link LearningEnvironment#getCompatibleStates(List)}
     */
    @Override
    ...
    /**
     * {@link LearningEnvironment#readCurrentState()}
     */
    @Override
    ...
    /**
     * {@link LearningEnvironment#getApplicableActions(int)}
     */
    @Override
    ...
    /**
     * {@link LearningEnvironment#performAction(int)}
     */
    @Override
    ...
    private void createStateSpace() {
        ...
        System.out.println("State space: " + stateSpace.size());
    }
    ...
    private Action getApplicableAction(String stateAxis, Boolean stateValue) {
        return actionSpace.values()
                ...
                .findFirst().orElseThrow(() -> new IllegalStateException("No Action available for " + stateAxis));
    }
